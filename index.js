/**
 * @module: ln-attribute
 * @author: wanglingdao <wanglingdao00@gmail.com> - 2015-05-01 23:21:26
 *
 * Attribute
 * -----------------
 * fork from:
 *  - https://github.com/aralejs/base/blob/master/src/attribute.js
 * Thanks to:
...
var merge, cloneValue;

merge = function merge(receiver, supplier) {
  var key;
...
cloneValue = function cloneValue(value, prev) {
  if (isArray(value)) {
    value = value.slice();
  ...
  for (key in inheritedAttrs) {
    if (inheritedAttrs.hasOwnProperty(key)) {
      ...
      for (i in ATTR_OPTIONS) {
        option = ATTR_OPTIONS[i];
        (value[option] !== undefined) && (attr[option] = value[option]);
      }
    }
  }
...
function isEmptyAttrValue(o) {
  return o === null || o === undefined || // null, undefined
